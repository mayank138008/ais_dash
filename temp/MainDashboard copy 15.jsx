...
export default function MainDashboard() {
  ...
  const [fullscreenChart, setFullscreenChart] = useState(null); // For fullscreen chart modal
              ...
              >
                <Popup minWidth={400}>
                  <div className="bg-gray-900 text-white p-2 rounded">
                    ...
                    <div className="mt-2 w-96 h-60">
                      <Line data={chartData} options={{ responsive: true, maintainAspectRatio: false, plugins: { legend: { display: false } }, scales: { x: { ticks: { color: '#fff', rotation: 45 }, grid: { color: 'rgba(255,255,255,0.1)' } }, y: { beginAtZero: true, ticks: { color: '#fff' }, grid: { color: 'rgba(255,255,255,0.1)' } } } }} />
                    </div>
                    <button
      ...
      {fullscreenChart && (
        <div className="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50">
          <div className="relative bg-gray-900 text-white p-4 rounded-lg max-w-5xl w-11/12 h-5/6 overflow-auto">
            <button
              className="absolute top-4 right-4 bg-red-600 text-white px-2 py-1 rounded"
            ...
            <Line
              ...
              options={{
                ...
                elements: { point: { radius: 5, hoverRadius: 8, backgroundColor: '#38bdf8', borderColor: '#fff', borderWidth: 1 }, line: { tension: 0.3, borderWidth: 2, borderColor: '#38bdf8' } },
              }}
              height={400}
            />
          </div>
